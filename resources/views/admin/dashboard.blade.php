    ...
    <div class="row">
        <div class="col-lg-3 col-6">
            ...
            <div class="small-box bg-info" style="height: 112px">
                <div class="inner">
                    <h3 style="color: #3d22b9">{{$c1}}</h3>

                    <p class="small-box-footer" ><p style="color: white">Today orders</p></p>
                </div>
                <div class="icon">
        ...
        <div class="col-lg-3 col-6">
            ...
            <div class="small-box bg-warning">
                <div class="inner">
                    ...
                    <a href="{{url("/admin")}}" class="small-box-footer" style="color: #940505"> <p>Today revenue</p></a>
                </div>
                <div class="icon">
                    <i class="ion ion-stats-bars"></i>
                </div>
    ...
    <div class="row" style="width: 2000px;margin-left: 35px">
        ...
        <section class="col-lg-7 connectedSortable" style="width: 100%;float: left">
            ...
            <div class="chart_line" style="width:100%;float: left;background-color: #454d55">
                ...
                <div class="chart_day_4" style="background-color: white;border-radius: 3px;margin-bottom: 20px;width: 49%;margin-left: 587px;margin-top: -300px">
                    <script src="https://cdnjs.cloudflare.com/ajax/libs/Chart.js/2.9.4/Chart.js"></script>
                    <body>
