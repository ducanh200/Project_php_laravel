...
//        dd($arr);
    ...
    public function orders(){
        ...
        $t1 = Carbon::now()->subDay(1)->format('d/m/Y');
        $t2 = Carbon::now()->subDay(2)->format('d/m/Y');
        $t3 = Carbon::now()->subDay(3)->format('d/m/Y');
    ...
    public function list_1(){
        ...
        $ordersYesterday = Order::whereDate('created_at', $yesterday)->get();


        return view("admin.list_1",[
    ...
    public function list_2(){
        ...
        $ordersTwoDaysAgo = Order::whereDate('created_at', $twoDaysAgo)->get();

        return view("admin.list_2",[
            "ordersTwoDaysAgo"=>$ordersTwoDaysAgo,
            "t"=>$t,
            "t1"=>$t1,
            "t2"=>$t2,
            "t3"=>$t3,
    ...
    public function list_3(){
        ...
        $orders = Order::OrderBy("id",'desc')->whereYear('created_at', $currentYear)->whereMonth('created_at', $currentMonth)->get();

        // Trả về view và truyền biến $orders vào view
        return view('admin.list_3', [
            'orders' => $orders,
            "t"=>$t,
            "t1"=>$t1,
            "t2"=>$t2,
    ...
    public function list_4(){
        ...
        $ordersThreeDaysAgo = Order::whereDate('created_at', $threeDaysAgo)->get();

        return view("admin.list_4",[
            "ordersThreeDaysAgo"=>$ordersThreeDaysAgo,
            "t"=>$t,
            "t1"=>$t1,
            "t2"=>$t2,
            "t3"=>$t3,
