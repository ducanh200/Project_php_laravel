...
Route::prefix("/admin")->middleware(["auth","admin"])->group(function (){
    ...
    Route::get("/list_1",[\App\Http\Controllers\AdminController::class,"list_1"]);
    Route::get("/list_2",[\App\Http\Controllers\AdminController::class,"list_2"]);
    Route::get("/list_3",[\App\Http\Controllers\AdminController::class,"list_3"]);
    Route::get("/list_4",[\App\Http\Controllers\AdminController::class,"list_4"]);
